...
Install & Set Up Environment : 
  ...
  - Create virtual environment(venv) using miniconda3 by this command : ``` conda create --name env_name python=3.7 (env_name is depend on name what you want) ```
  ...
  - Create SubFolder like this :
    ...
    --name
      ...
      |__val
         ...
         |__labels
    ```
    Folder train is use for train model and folder val is use for valid as you train
  ...
  ![images](https://github.com/supaphol170/yolov8_senior_project/ISM human detection.png)
